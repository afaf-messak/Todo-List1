...
<body>
    ...
    <script>
        ...
        if (window.location.search.includes('celebrate=1')) {
            ...
            celebrationDiv.innerHTML = <h3>Félicitations ! 🎉</h3><p>${message}</p><button id="close-celebration">Fermer</button>;
            document.body.appendChild(celebrationDiv);
            const closeBtn = celebrationDiv.querySelector('#close-celebration');
            if (closeBtn) {
                closeBtn.addEventListener('click', function () { celebrationDiv.remove(); });
            }
        }
